        ...
        <div style={{ padding: "16px 18px 14px", borderBottom: "1px solid var(--line)", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p className="pii" style={{ margin: 0, fontFamily: "Anton, sans-serif", fontSize: 16, letterSpacing: 0.3, color: "var(--ink)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {userName}
              </p>
              {!loading && (
