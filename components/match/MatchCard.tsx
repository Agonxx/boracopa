            ...
            {predsLoading ? (
              ...
              return (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", borderRadius: 12, background: "var(--surface)", border: "1px solid var(--line)" }}>
                  <div className="pii" style={{ width: 30, height: 30, borderRadius: "50%", flexShrink: 0, background: "var(--primary-soft)", display: "grid", placeItems: "center", fontFamily: "Anton, sans-serif", fontSize: 11, color: "var(--primary-strong)" }}>
