...
export default function ScoringNote() {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 12.5, color: "var(--ink-2)", lineHeight: 1.45, flex: 1 }}>
      ...
      <Link href="/regras" style={{ fontSize: 12, fontWeight: 700, color: "var(--ink-3)", textDecoration: "none", whiteSpace: "nowrap", flexShrink: 0 }}>
        Ver regras →
      </Link>
    </div>
  );
