  ...
  const body = (
    <div style={{ display: "flex", flexDirection: "column", gap: 16, fontFamily: "Archivo, sans-serif" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        <div className="pii" style={{ width: 56, height: 56, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg, var(--primary) 0%, var(--primary-strong) 100%)", display: "grid", placeItems: "center", color: "var(--on-primary)", fontFamily: "Anton, sans-serif", fontSize: 23 }}>
          {initials}
        </div>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div className="pii" style={{ fontSize: 18, fontWeight: 800, letterSpacing: -0.2, color: "var(--ink)" }}>{user.name}</div>
          <div className="pii" style={{ fontSize: 12.5, color: "var(--ink-2)", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
